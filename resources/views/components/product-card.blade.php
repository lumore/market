...
<div class="flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
    <a href="{{ route('product', $product->slug) }}" class="block w-1/3 bg-cover"
    ...
    <div class="w-2/3 p-4">
        <a href="{{ route('product', $product->slug) }}" title="{{ $product->name }}">
            <h1 class="text-gray-900 font-bold text-2xl whitespace-nowrap overflow-hidden overflow-ellipsis">{{ $product->name }}</h1>
        </a>
